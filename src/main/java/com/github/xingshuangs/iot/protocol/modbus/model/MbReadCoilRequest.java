...
public final class MbReadCoilRequest extends MbPdu {
    ...
    public static MbReadCoilRequest fromBytes(final byte[] data, final int offset) {
        ...
        MbReadCoilRequest request = new MbReadCoilRequest();
        request.functionCode = EMbFunctionCode.from(buff.getByte());
        request.address = buff.getUInt16();
        request.quantity = buff.getUInt16();
        return request;
    }
}
