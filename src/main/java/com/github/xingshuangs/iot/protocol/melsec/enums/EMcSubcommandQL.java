...
public enum EMcSubcommandQL {
    ...
    private static Map<Integer, EMcSubcommandQL> map;

    public static EMcSubcommandQL from(int data) {
        if (map == null) {
            map = new HashMap<>();
            for (EMcSubcommandQL item : EMcSubcommandQL.values()) {
