...
public class H264NaluTest {
    ...
    public void h264NaluFuA_Start() {
        ...
        assertFalse(nalu.header.isForbiddenZeroBit());
        assertEquals(3, nalu.header.getNri());
        assertEquals(EH264NaluType.FU_A, nalu.header.getType());
        assertArrayEquals(payload, nalu.payload);
    ...
    public void h264NaluSingle() {
        ...
        assertFalse(nalu.header.isForbiddenZeroBit());
        assertEquals(3, nalu.header.getNri());
        assertEquals(EH264NaluType.NON_IDR_SLICE, nalu.header.getType());
        assertArrayEquals(payload, nalu.payload);
    }
}