...
public class RtcpTest {
    ...
    @Test
    public void rtcpAppTest() {
        byte[] expect = new byte[]{(byte) 0x81, (byte) 0xCB, (byte) 0x00, (byte) 0x01, (byte) 0xC3, (byte) 0x45, (byte) 0x17, (byte) 0xFC
                , (byte) 0x30, (byte) 0x31, (byte) 0x32, (byte) 0x41};
        RtcpApp app = RtcpApp.fromBytes(expect);
        assertEquals(2, app.getHeader().getVersion());
        assertFalse(app.getHeader().isPadding());
    ...
    @Test
    public void rtcpReceiverReportTest() {
        ...
        RtcpReceiverReport receiverReport = RtcpReceiverReport.fromBytes(expect);
    ...
    @Test
    public void rtcpSenderReportTest() {
        ...
        RtcpSenderReport senderReport = RtcpSenderReport.fromBytes(expect);
    ...
    @Test
    public void rtcpSdesReportTest() {
        byte[] expect = new byte[]{(byte) 0x81, (byte) 0xCA, (byte) 0x00, (byte) 0x07, (byte) 0x55, (byte) 0xA9, (byte) 0x65, (byte) 0x0B
        ...
        RtcpSdesReport sdesReport = RtcpSdesReport.fromBytes(expect);
        ...
        byte[] actual = sdesReport.toByteArray();
        assertArrayEquals(expect, actual);
    }
}